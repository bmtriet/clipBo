...
export const translations = {
  en: {
    ...
    debug: "Debug logging",
    responseFallback: "Show result dialog when copy succeeds",
    responseFallbackHint: "When paste is not possible, clipBo shows the result in a dialog so you can view and copy.",
  ...
  vi: {
    ...
    debug: "Bật debug log",
    responseFallback: "Hiển thị dialog kết quả khi copy thành công",
    responseFallbackHint: "Khi không paste được, clipBo hiển thị kết quả trong dialog để bạn xem và copy.",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
  ...
  zh: {
    ...
    uiLanguage: "界面语言",
    debug: "调试日志",
    responseFallback: "复制成功后显示结果对话框",
    responseFallbackHint: "无法粘贴时，clipBo 在对话框中显示结果，方便查看和复制。",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
