...
export const translations = {
  en: {
    ...
    debug: "Debug logging",
    responseFallback: "Notify when result is copied",
    responseFallbackHint: "When paste is not possible, clipBo shows a macOS notification. Click the dock icon to view the result.",
  ...
  vi: {
    ...
    debug: "Bật debug log",
    responseFallback: "Thông báo khi đã copy kết quả",
    responseFallbackHint: "Khi không paste được, clipBo gửi thông báo macOS. Bấm dock icon để xem kết quả.",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
  ...
  zh: {
    ...
    uiLanguage: "界面语言",
    debug: "调试日志",
    responseFallback: "复制结果时通知",
    responseFallbackHint: "无法粘贴时，clipBo 发送 macOS 通知。点击 Dock 图标可查看结果。",
    providerLabel: "AI Provider",
    geminiKey: "Gemini API Key",
    geminiModel: "Gemini Model",
    openaiKey: "OpenAI API Key",
