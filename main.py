...
text_widget = tk.Text(text_frame, font=font_text, wrap="word", relief="solid", bd=1, highlightthickness=1, highlightcolor="#0d7a8a", highlightbackground="#e5e7eb", height=4)
